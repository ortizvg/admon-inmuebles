...
public final class SecurityUtils {
    ...
    public static boolean isAuthenticated() {
        ...
        return Optional.ofNullable(securityContext.getAuthentication())
                .map(authentication -> authentication.getAuthorities().stream().noneMatch(grantedAuthority -> grantedAuthority.getAuthority().equals(RolConst.ROLE_ANONIMO))).orElse(false);
    }
