...
//			nativeQuery = true)
    ...
    @Query(value = "select distinct(inm.id_inmueble), inm.*  from gescopls.tickets t\r\n" + 
    		"    		join gescopls.usuarios prov on t.id_usuario_asignado_fk = prov.id_usuario\r\n" + 
    		"    		join gescopls.inmuebles_socios inso on t.id_usuario_creador_fk = inso.socios_id_usuario \r\n" + 
    		"    		join gescopls.inmuebles inm on inso.Inmueble_id_inmueble = inm.id_inmueble \r\n" + 
    		"    		where prov.id_usuario = ?1", 
			nativeQuery = true)
